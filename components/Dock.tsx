              ...
              <div className="border-b p-2">
                <div className="flex flex-wrap gap-1">
                  {Object.keys(mathSymbols).map((category) => (
                    <Button
                      key={category}
                      variant={mathCategory === category ? "default" : "ghost"}
                      size="sm"
                ...
                <div className="grid grid-cols-4 gap-2">
                  {mathSymbols[mathCategory].map((item) => (
                    <Tooltip key={item.symbol}>
                      <TooltipTrigger asChild>
                        <button
                          className="flex h-14 w-full items-center justify-center rounded-xl bg-gradient-to-br from-violet-50 to-indigo-50 text-3xl shadow-sm transition-all hover:scale-110 hover:shadow-md hover:from-violet-100 hover:to-indigo-100 dark:from-violet-950/50 dark:to-indigo-950/50 dark:hover:from-violet-900/50 dark:hover:to-indigo-900/50"
                          onClick={() => {
                            onInsertSymbol?.(item.symbol)
                            setMathOpen(false)
                          }}
                        >
                          <span className="drop-shadow-sm">{item.symbol}</span>
                        </button>
                      </TooltipTrigger>
